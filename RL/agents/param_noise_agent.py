...
class ParamNoiseAgent(RL.Agent):
    def __init__(self, context: RL.Context, name, modal_class, source_model, target_divergence=None, adaptation_factor=None):
    ...
    def post_episode(self, env_id_nos):
        if 0 in env_id_nos and not self.runner.exploit_modes[0]:
